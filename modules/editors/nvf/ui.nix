...
in
{
  programs.nvf.settings.vim = {
    ...
    luaConfigPost = ''
      ...
      set_hl("Question", { fg = colors.base0F })
      ...
      set_hl("Conceal", { fg = colors.base0F, bg = colors.base00 })
      ...
      set_hl("Identifier", { fg = colors.base0D })
      set_hl("Include", { fg = colors.base0F })
      ...
      set_hl("@function", { fg = colors.base0F })
      set_hl("@function.call", { fg = colors.base0F })
      set_hl("@function.builtin", { fg = colors.base0F })
      set_hl("@method", { fg = colors.base0F })
      set_hl("@method.call", { fg = colors.base0F })
      ...
      set_hl("DiagnosticFloatingInfo", { fg = colors.base0F, bg = colors.base01 })
